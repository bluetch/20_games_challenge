...
@onready var player_1_score_label: Label = $SafeMargin/HUDVBox/TopBar/Player1ScoreLabel
@onready var player_2_score_label: Label = $SafeMargin/HUDVBox/TopBar/Player2ScoreLabel
